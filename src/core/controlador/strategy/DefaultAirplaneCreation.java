 ...
 * @author Juan Manuel
 */
public class DefaultAirplaneCreation implements AirplaneCreationStrategy{
    @Override
    public Response createAirplane(String id, String brand, String model, int maxCapacity, String airline) {
        try {
